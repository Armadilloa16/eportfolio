...
{\huge 3. Choose two points in the scatterplot above to draw a line of best fit through so that roughly half the points are above the line, and half are below. Draw that line, and then calculate the equation that describes that line by calculating it's slope and y-intercept.}
