...
\end{itemize}
or some combination thereof. All of these possibilities will be associated with higher than average levels of mathematics anxiety, and negagive preconceptions of mathematics. So the question here is
...
\end{itemize}
The one common conclusion from all the literature and common implication from every framework considered above, is that these are two key barriers must both be addressed in order to have the most effective and longlasting impact on student's success. 

Students enrolling in bridging courses have commented on this. In the survey of \citeA{Gordon2013}, 
\begin{quote}
...
DRAFT OF CONDENSED CONCLUSIONS/ TAKE-AWAY MESSAGES:
\begin{itemize}
	\item ``The Mathematics Problem'', declining interest in mahtematics is a serious problem. The gender-gap in mathematics education is a continuingly serious problem.
	\item Success in secondary school mathematics is highly predictive of success and even participation in tertiary mathematics education. More so than any ``remidial'' approach or the effect of any bridging course \cite{Kajander2005, Nicholas2015b}
	\item The secondary-tertiary transition can be though of as a modern day ``rite-of-passage'', and this model for this transition can give us some important insight into approaches that are important to helping students through it, specifically:
		\begin{itemize}
			\item It is not only a difficulty experienced by the students engaging in the transition, but their wider community (family, friends) are involved, and the negative perceptions of mathematics held by this wider community plays an important role in determining the student's success \cite{King2015, Gordon2013}.
			\item We can help students by setting clear expectations: it is going to be difficult, and that is ok. It is not going to get easier quickly, it will continue to be difficult, and that is ok. Expecting difficulty makes it easier to cope with, because they can go into it emotionally prepared for it.
			\item Another set of expectations to set are around the tertiary learning environment: students are expected to be responsible for their own learning. 
			\item Supporting students to establish a new social network/ support structure around them in their new environment/ community is critical. Encouraging them and providing opportunities for them to network, to meet each other, and make freinds will benefit their success greatly. They are human beings first, and students second. It has been shown that social and interactive learning as a formative element of early university experience is highly predictive of retention \cite{Peat2001, Trotter2006}, particularly for students from non-academic or ``working class'' backgrounds \cite{Leese2010}, connecting to the first dot point above about the importance of community perceptions.
		\end{itemize}
	\item Setting clear expectations is important, and the conditions of entry into university being relaxed introduces much uneeded ambiguity into the expectations of students going into tertiary education.
	\item Perceptions of mathematics are critical, and have a key connection with maths anxiety.
	\item The ``Interpretation Account'' of \citeA{Ramirez2018} provides a framework for understanding the critical connection between maths performance and maths anxiety/ perceptions of maths. This is a central theme of much of the literature and a core issue underlying most of the challenges faced by students in this area. This framework also provides some insight into how to intervene to break these cycle. The primary take-away is that addressing students affect towards mathematics (i.e. maths anxiety/ perceptions of mathematics) or their mathematics performance (content knowledge, curriculum, etc) will not be effective alone as even if one is improved, the cycle of \citeA{Ramirez2018} will re-establish itself in the long term. In order to have lasting effect, this framework implies that both must be tackled simultaneously. This supports the ideas of the \reffig{diamond} that these different areas are inextricably linked to each other and cannot be treated separately or else risk ineffective interventions in the longterm.
\end{itemize}
SINGLE TAKE-AWAY MESSAGE: Setting clear expectations is critical.

approaches implied by the literature centre on setting clear expectations around ``productive struggle'', revaluation of physiological signs of stress, encouraging discussion and social interaction, ...



\begin{itemize}
	\item Setting clear expectations is critical. Although addressing the misconceptions arond mathematics not being critical for other diciplines of study such as science and engineering is beyond the scope of what can be acheived in a bridging course context, students should be explicitly told that the first semester will be hard. It will be stressful. But that it will be worth it. To expect difficulty, but to embrace it. Several frameworks suggest this, including the rite-of-passage model of \citeA{Clark2008} and the re-evaluation model for maths anxiety from clinical psychology. An emphasis should be placed on not setting expectations that the difficult period will pass quickly, but rather that it is a natural, expected transitionary period. That it will continue to be difficult, but that that is ok. Each of these frameworks suggest that if students are aware of the difficulty ahead of time, they will be more prepared to deal with it when it occurs, and are more likely to be able to do so in a productive manner and be successful despite the challenges.
