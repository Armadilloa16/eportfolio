...
\addcontentsline{toc}{section}{A Guide to Negotiated Education Plans for Pre-service and New Teachers (Edward Bonner)}
\label{aut:bonner}
...
\addcontentsline{toc}{section}{Students with Refugee Experience in Science (Tory West)}
\label{aut:west}
...
\addcontentsline{toc}{section}{Numerous Problems: Inclusion of Students with Dyscalcula in Secondary STEM Education (Kyuseop `Anton' Suh)}
\label{aut:suh}
