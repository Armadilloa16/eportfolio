...
\begin{tikzpicture}[node distance=0.9cm,thick,topic node/.style={ellipse,draw,font=\footnotesize},unit node/.style={ellipse,draw,font=\large}]
	...
	% Functions and Graphs
  	\node[unit node] (ms2) [below=0.2cm of ms] {MS2};
	...
	% Complex Numbers
  	\node[unit node] (ms1) [below=0.7cm of mt4] {MS1};
	...
	% Annotations
	\node[gray, rotate=90, yshift=42pt] (ac1) at (acmmmu2t2) {Functions and Graphs};
	\node[gray, rotate=90, yshift=42pt] (ac2) at (acmsmu4t2) {Calculus};
	\node[gray, rotate=90, yshift=42pt] (ac3) at ($(acmsmu1t2)!0.5!(acmsmu3t3)$) {Linear Algebra};
	\node[gray, rotate=90, yshift=42pt] (ac4) at ($(acmsmu2t3)!0.5!(acmsmu3t1)$) {Numbers};
	\node[gray, rotate=90, yshift=42pt] (ac5) at ($(acmmmu3t3)!0.5!(acmmmu4t2)$) {Probability and Statistics};
