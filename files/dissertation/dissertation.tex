...
\begin{itemize}
	...
	\item Calculus: 
		\begin{itemize}
			\item SMu4t1 aligns well to S2SM5, both covering integration by parts, by substitution, inverse trig substitutions in integration problems and solids of revolution, but the \gls{ac} has more of a focus on partial fractions, while \gls{sace} looks at area between two curves, a concept covered in the \gls{ac} but under a different topic --- XXXXXX.
			...
			\item MMu2t3 to S1M6,
			\item MMu3t1 to S2MM1,
			\item MMu3t2 to S2MM3
		\end{itemize}
	\item Geometry and Linear Algebra
		\begin{itemize}
			\item Vectors in the Plane SMu1t2 to S1M9,
			\item Proof and Circle Theorems SMy1t3 to S1M8,
			\item Matrices SMu2t2 to S1M11, 
			\item Vectors in 3D SMu3t3 to S2SM4
		\end{itemize}
	\item Complex Numbers SMu2t3 to S1M12 and SMu3t1 to S2SM2
	\item Probability and Statistics MMu1t3, MMu3t3, MMu4t2, MMu4t3, SMu1t1, SMu4t3 to S1M4, S2MM2, S2MM5, S2MM6. Note: Cumulative Distribution Function not mentioned in \gls{sace}
\end{itemize}
